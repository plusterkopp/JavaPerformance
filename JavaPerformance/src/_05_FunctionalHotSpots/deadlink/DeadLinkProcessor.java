...
//        	System.out.println("CHECK - file: "+htmlFileName+" -- "+"checking "+URIChecker.getScheme(href)+": "+href);
        	...
        	if (
                 (LabelChecker.isLocalLabel(href) && !LabelChecker.isAvailableLocalLabel(htmlFileName,href))
              || (RelativeLinkChecker.isRelativeFileLink(href) && !RelativeLinkChecker.isAvailableRelativeLink(htmlFileName,href))
